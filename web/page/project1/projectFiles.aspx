...
<body class="childrenBody">
   <%-- <form runat="server">--%>
        ...
        <%--<blockquote class="layui-elem-quote layui-quote-nm" style="font-size:16px;font-weight:bold;background-color:cadetblue">文件列表</blockquote>
	        <div class="layui-form news_list" >
	  	        <table class="layui-table" style="height:100px">
		            <colgroup>
                        <col width="5%" />
				        <col width="10%" />
				        <col width="10%" />
    ...
    <blockquote class="layui-elem-quote layui-quote-nm" style="font-size:16px;font-weight:bold;background-color:cadetblue">文件列表</blockquote>
        <form class="layui-form">
            <%--<iframe id="projectfileslist" class="fullHeight" width="100%" frameborder="0" src="./projectFiles.aspx?proid=1" onload="LoadHeight(this)">抱歉！该页面不支持您的浏览器！</iframe>--%>
            <div id="listPageDiv" runat="server"></div>
        </form>
