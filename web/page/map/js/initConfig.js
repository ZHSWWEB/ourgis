...
var layerConfiguration = {
    ...
    dissertation: {
        ...
        zhili187: {
            ...
            type: "polygon",
            titleField: 'HCMC',
            outFields: ['HCMC', 'HCBM', 'HCGN', 'HCFL', 'HCCD', 'LYMJ', 'HCKD', 'SMMJ', 'XZQ', 'HZXM', 'ISKQY', 'ISHC', 'SGNYJQ', 'SQNEJQ', 'SGNQSZMB', 'SJFHBZ', 'SJPLBZ', 'ZZCD', 'QDMC', 'QDQX', 'QDJZ', 'QD_X', 'QD_Y', 'ZDMC', 'ZDQX', 'ZDJZ', 'ZD_X', 'ZD_Y', 'SSPLP', 'SZLY', 'SJHLMC', 'SJHLDM', 'HLJB', 'XGRQ'],
            displayFields: ['河涌名称', '河涌编码', '河涌功能', '河涌分类', '河涌长度（km）', '流域面积（km2）', '河涌宽度（m）', '水面面积（万m2）', '行政区', '河长', '是否跨区域', '是否黑臭', '水功能一级区划', '水功能二级区划', '水功能区水质目标', '设计防洪标准（年）', '设计排涝标准（年）', '整治长度（km）', '起点（源头）位置 名称', '起点位置 区县', '起点位置 街镇', '起点坐标X', '起点坐标Y', '终点（河口）位置 名称', '终点位置 区县', '终点位置 街镇', '终点坐标X', '终点坐标Y', '所属排涝片', '所在流域名称', '上级干流名称', '上级干流编码', '河流级别', '修改日期'],
            dateFields: [],
