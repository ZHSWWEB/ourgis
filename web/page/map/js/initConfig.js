...
//本机token的地址http://192.168.2.16/ourgis/
...
var layerConfiguration = {
    baseMap: {
        weixingyingxiang: commandUrl + "QuanLiuYu/weixingyingxiang/MapServer" + token,
        dituT: commandUrl + "QuanLiuYu/ditu/MapServer" + token,
        dituD: commandUrl + "QuanLiuYu/ditu1/MapServer" + token,
        jichushuju: commandUrl + "QuanLiuYu/jichushuju/MapServer" + token,
        paishui: commandUrl + "QuanLiuYu/paishui/MapServer" + token,
        shuili: commandUrl + "QuanLiuYu/shuili/MapServer" + token,
        jietubiao: commandUrl + "QuanLiuYu/jietubiao/MapServer" + token,
    },
    dissertation: {
        daolu: {
            name: '道路',
            ...
            queryflag: 4,
            followvisit: "jichushujuLayer",
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/jichushuju/MapServer/6" + token,
            type: "polyline",
            titleField: '道路名',
            outFields: ["道路名"],
            displayFields: ["道路名"],
        ...
        hechong: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/shuili/MapServer/5" + token,
            type: "polygon",
            titleField: 'RVNM',
        ...
        shuiku: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/shuili/MapServer/4" + token,
            type: "polygon",
            titleField: 'RSNM',
            outFields: ["OBJECTID", "RSNM", "RSCD", "ALIAS", "PRST", "SKJB", "PRGR", "MNBLGR", "MNUN", "CMUN", "BLSYS", "XZQ", "VLTW", "SZLYMC", "CTCD", "SZHL", "RVCD", "ESLG", "NRLT", "EQMTPKACLT", "BSSSIN", "FREQIN", "GCXT", "JCSJ", "ISRG", "RSOV", "DTUPDT", "BDGC", "CSMMJ", "FHGSW", "FHKR", "FHXZSW", "GGMJ", "LYMJ", "SJHSBZ", "SJHSW", "SQNQEJQ", "SQNQSZMB", "SGNQYJQ", "SKGN", "SKLX", "SKTJXN", "SKR", "SSW", "THKR", "XSJB", "JHHSBZ", "JHHSW", "XLKR", "ZCXSW", "ZBBG", "ZBBC", "ZKR", "ZDHXLL", "ZDXHLL", "REMARK", "F330", "XGR", "XGBM", "XGRQ"],
        ...
        hupo: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/shuili/MapServer/3" + token,
            type: "polygon",
            titleField: 'LKNM',
        ...
        shuizha: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/shuili/MapServer/1" + token,
            type: "point",
            titleField: 'SLNM',
        ...
        bengzhan: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/shuili/MapServer/0" + token,
            type: "point",
            titleField: "IDSTNM",
        ...
        zhili187: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/zhuanti/MapServer/5" + token,
            type: "polygon",
            titleField: 'RVNM',
        ...
        zhili35: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/zhuanti/MapServer/4" + token,
            type: "polygon",
            titleField: 'RVNM',
            outFields: ["OBJECTID", "RVNM", "RVCD", "ALIAS", "RVTP", "DWWT", "DWWTCD", "HWPS", "HWEL", "ESPS", "ESEL", "DTPL", "RVLEN", "AVGG", "CTAR", "AVANRNAM", "ANRNSTDV", "RVOV", "DTUPDT", "SSLYDM", "SSLYMC", "HDDJ", "XZQ", "HCFL", "HZ_SHI", "HZ_QU", "HZ_JIEDAO", "ISKQY", "F35", "F187", "F1368", "SJFHBZ", "SJPLBZ", "SGNYJQ", "SGNEJQ", "SGNQSZMB", "HLPJKD", "SMMJ", "REMARK"],
            displayFields: ["数据ID", "河流名称", "河流代码", "别名／曾用名", "河流类别", "汇入水域", "汇入水域代码", "河源位置", "河源高程", "河口位置", "河口高程", "水准基面", "河流长度(km)", "平均比降", "流域面积", "多年平均径流量", "年径流量标准差", "河流概况", "数据更新日期", "所属流域代码", "所属流域名称", "河道等级", "所属行政区", "河涌分类", "市级河长", "区级河长", "街道河长", "跨区数量", "35条黑臭河涌编号", "187条黑臭河涌编号", "1368条河涌编号", "设计防洪标准", "设计排涝标准", "水功能一级区划", "水功能二级区划", "水功能区水质目标", "河涌平均宽度(m)", "水面面积(km2)", "备注"],
        ...
        projectInfo: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/projectInfo/FeatureServer/0" + token,
            type: "point",
            titleField: 'NAME',
        ...
        interestPolygon: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/interestPolygon/FeatureServer/0" + token,
            type: "polygon",
            titleField: 'NAME',
        ...
        interestPolyline: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/interestPolyline/FeatureServer/0" + token,
            type: "polyline",
            titleField: 'NAME',
            outFields: ["NAME", "REMARK", "CJR", "CJBM", "CJRQ", "XGR", "XGBM", "XGRQ", "OBJECTID"],
            displayFields: ["名称", "备注", "创建人", "创建部门", "创建日期", "修改人", "修改部门", "修改日期"],
        ...
        interestMultiPoint: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/interestMultiPoint/FeatureServer/0" + token,
            type: "multipoint",
            titleField: 'NAME',
            outFields: ["NAME", "REMARK", "CJR", "CJBM", "CJRQ", "XGR", "XGBM", "XGRQ", "OBJECTID"],
            displayFields: ["名称", "备注", "创建人", "创建部门", "创建日期", "修改人", "修改部门", "修改日期"],
        ...
        interestPoint: {
            ...
            minScale: 0,
            maxScale: 0,
            url: commandUrl + "QuanLiuYu/interestPoint/FeatureServer/0" + token,
            type: "point",
            titleField: 'NAME',
            outFields: ["NAME", "REMARK", "CJR", "CJBM", "CJRQ", "XGR", "XGBM", "XGRQ", "OBJECTID"],
            displayFields: ["名称", "备注", "创建人", "创建部门", "创建日期", "修改人", "修改部门", "修改日期"],
