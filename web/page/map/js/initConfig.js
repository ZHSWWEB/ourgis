...
var layerConfiguration = {
    ...
    dissertation: {
        ...
        difang: {
            ...
            type: "polyline",
            titleField: 'LVNM',
            outFields: ["LVCD", "LVNM", "PRST", "LVGR", "LVTP", "MNUN", "CMUN", "BLSYS", "CTCD", "RVCD", "BNSD", "LVINPS", "LVINCH", "LVINEL", "LVTRPS", "LVTRCH", "LVTREL", "LVLEN", "MAXLVHG", "RVSDBNPTCN", "NSDBNPTCN", "BSSSIN", "FREQIN", "DTPL", "CPYR", "LVOV", "DTUPDT", "BZSL", "DBCD", "DDKD_MAX", "DDKD_MIN", "DFBM", "DFGD_MIN", "DFGD_MAX", "DFLX", "DHXSL", "GCRW", "GHSL", "GLDWBM", "JCSJ_Y", "KJQK", "QD_XZQBM", "QDWZ_Q", "QDWZ_Z", "QDWZ_C", "SFWCHJ", "SFWCQQ", "SJBZ", "SJSW", "SZHL", "SZSL", "XH", "ZD_XZQBM", "ZDWZ_Q", "ZDWZ_Z", "ZDWZ_C", "SZHLBM", "JSQK", "DFJB", "DFXS", "GLBM", "HLAB", "QDWZ_J", "GCXT", "XGR", "XGBM", "XGRQ"],
            displayFields: ["堤防(段)代码", "堤防(段)名称", "工程状态", "堤防(段)级别", "堤防(段)类型", "管理单位", "主管单位", "归属部门", "所在流域代码", "所在河流代码", "岸别", "堤防(段)起点位置", "堤防(段)起点桩号", "堤防(段)起点高程", "堤防(段)终点位置", "堤防(段)终点桩号", "堤防(段)终点高程", "堤防(段)长度", "最大堤高", "临水面护岸情况", "背水面护坡情况", "地震基本烈度", "设防地震烈度", "水准基面", "建成年份", "堤防(段)概况", "数据更新日期", "泵站数量(处)", "达到规范防洪(潮)标准的长度", "堤顶宽度(m)(最大值)", "堤顶宽度(m)(最小值)", "堤防编码", "堤防高度(m)(最小值)", "堤防高度(m)(最大值)", "堤防类型", "倒虹吸数量(个)", "工程任务", "管涵数量(个)", "堤防工程管理单位编码", "建成时间(月)", "跨界情况", "起点行政区划代码", "起点位置区", "起点位置镇", "起点位置村", "是否完成划界", "是否完成确权", "规划防洪(潮)标准(年)", "设计水(高潮)位(m)", "所在河流", "水闸数量(个)", "索引序号", "终点行政区划代码", "终点位置区", "终点位置镇", "终点位置村", "所在河流编码", "工程建设情况", "堤防级别", "堤防型式", "堤防工程归口管理部门", "河流岸别", "起点位置街(村)", "高程系统", "修改人", "修改部门", "修改日期"],
            dateFields: ["数据更新日期", "修改日期"],
            queryField: ["LVNM"],
            statisticsFields: {},
            statType: 'other',
