...
var layerConfiguration = {
    ...
    dissertation: {
        ...
        shuizha: {
            ...
            type: "point",
            titleField: 'SLNM',
            outFields: ["OBJECTID", "IDSTNM", "IDSTCD", "IDSTTP", "MNUN", "CMUN", "XZQ", "VLTW", "SZLYMC", "CTCD", "SZHL", "RVCD", "ESLG", "NRLT", "MNUS", "INPW", "INFLW", "UNAM", "PMTP", "DRAR", "IRAR", "PMDSDLHD", "JCSJ", "IDSTOV", "DTUPDT", "BZJB", "GCXT", "GCDB", "SJPLBZ", "SSPLP", "XSJB", "XGR", "XGBM", "XGRQ"],
            displayFields: ["数据ID", "机电排灌站名称", "机电排灌站代码", "机电排灌站类别", "管理单位", "主管单位", "所在地点行政区划", "所在乡镇", "所在流域", "所在流域代码", "所在河流", "所在河流代码", "东经", "北纬", "主要用途", "装机功率", "装机流量", "机组台数", "泵型", "排涝面积", "灌溉面积", "泵站设计扬程", "建成年份", "机电排灌站概况", "数据更新日期", "泵站级别", "高程系统", "工程等别", "设计排涝标准", "所属排涝片", "显示级别", "修改人", "修改部门", "修改日期"],
            dateFields: ["数据更新日期","建成时间", "修改日期"],
