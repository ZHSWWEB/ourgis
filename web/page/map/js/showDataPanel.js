...
function showQuanJingPanel() {
    selectKey = "quanjingtu";
    //document.getElementById("rightInfoWindow").style.display = "none";//全景图时隐藏统计面板
    queryLayer(layerConfiguration.dissertation[selectKey].url, "XZQ", layerConfiguration.dissertation[selectKey].name, "全景数据数量", "行政区", false);
    initSelectField();
}

function showHeChongPanel() {
    selectKey = "heicong";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "HCGN", layerConfiguration.dissertation[selectKey].name, "河涌数量", "河涌功能", false);
    initSelectField();
}

function showHuPoPanel() {
    selectKey = "lake";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "GCDB", layerConfiguration.dissertation[selectKey].name, "湖泊数量", "工程等别", false);
    initSelectField();
}

function showShuiZhaPanel() {
    selectKey = "shuizha";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "SZLX", layerConfiguration.dissertation[selectKey].name, "水闸数量", "水闸类型", false);
    initSelectField();
}

function showBengZhanPanel() {
    selectKey = "bengzhan";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "BZLX", layerConfiguration.dissertation[selectKey].name, "泵站数量", "泵站类型", false);
    initSelectField();
}

function showDiFangPanel() {
    selectKey = "difang";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "DFLX", layerConfiguration.dissertation[selectKey].name, "堤防数量", "堤防类型", false);
    initSelectField();
}

function showShuiKuPanel() {
    selectKey = "shuiku";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "SKLX", layerConfiguration.dissertation[selectKey].name, "水库数量", "水库类型", false);
    initSelectField();
}

function showChengZhongCunPanel() {
    selectKey = "chengzhongcun";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "区", layerConfiguration.dissertation[selectKey].name, "城中村数量", "行政区", true);
    initSelectField();
}

function showChengShiGengXinPanel() {
    selectKey = "chengshigengxin";
    queryLayer(layerConfiguration.dissertation[selectKey].url, "更新类型", layerConfiguration.dissertation[selectKey].name, "更新类型", "更新类型", false);
    initSelectField();
}

function showInterestPointPanel() {
    document.getElementById("rightInfoWindow").style.display = "none";//全景图时隐藏统计面板
    selectKey = "interestPoint";
}

function showGongshuihuFeiJuminPanel() {
    selectKey = 'paishuihuFeiJumin';
    queryLayer(layerConfiguration.dissertation[selectKey].url, "水表分区", layerConfiguration.dissertation[selectKey].name, "水表分区", "水表分区", false);
    initSelectField();
}

function showGongshuihuJuminPanel() {
    selectKey = 'paishuihuJumin';
    queryLayer(layerConfiguration.dissertation[selectKey].url, "水表分", layerConfiguration.dissertation[selectKey].name, "水表分区", "水表分区", false);
    initSelectField();
}

function showPaiFangKouPanel() {
    selectKey = 'paifangkou';
    queryLayer(layerConfiguration.dissertation[selectKey].url, "DISTRICT", layerConfiguration.dissertation[selectKey].name, "行政区划", "行政区划", false);
    initSelectField();
}

function showPaiShuiXuKePanel() {
    selectKey = 'paishuixuke';
    queryLayer(layerConfiguration.dissertation[selectKey].url, "性质", layerConfiguration.dissertation[selectKey].name, "单位性质", "单位性质", false);
    initSelectField();
}
