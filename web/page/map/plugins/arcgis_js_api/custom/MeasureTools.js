...
define([
    ...
    return declare(_WidgetBase, {
        ...
        _initalToolbar: function () {
            ...
            query("." + this.srcRefNode + " >li>.measure-distance").on("click", lang.hitch(this, this._startMeasureDistance));
            query("." + this.srcRefNode + " >li>.measure-area").on("click", lang.hitch(this, this._startMeasureArea));
        },
        ...
        _drawComplete: function (evt) {
            ...
            //关闭绘制标记
            isDrawing = false;//判断是否正在增加绘制，如果是，则地图点击查询的功能需要暂时停止。
            //关闭绘制标记
        },
        ...
        _startMeasureDistance: function () {
            ...
            this.toolbar.deactivate();
            //启用绘制标记
            isDrawing = true;//判断是否正在增加绘制，如果是，则地图点击查询的功能需要暂时停止。
            //启用绘制标记
